...
from ssd.config import vgg_ssd_config, mobilenetv1_ssd_config, squeezenet_ssd_config
...
from ssd.squeezenet_ssd_lite import create_squeezenet_ssd_lite
from ssd.ssd import MatchPrior
from ssd.vgg_ssd import create_vgg_ssd
from utils import freeze_net_layers, str2bool, Timer, store_labels
...
if __name__ == '__main__':
    ...
    train_set, val_set = torch.utils.data.random_split(train_dataset, [len(train_dataset)-3000, 3000])
